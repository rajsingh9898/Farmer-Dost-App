# Farmer Dost App — Problem Statement & Objectives
...
2. To maintain a centralized, tamper-resistant database of genuine product batches that can be checked against scanned codes.
3. To provide farmers with a simple mechanism to report suspected counterfeit products, helping identify fraudulent sellers and protect other farmers.
4. To create a farmer profile system that stores scan history, enabling farmers to track products they have previously verified.
